...
<head>
  ...
  <link rel="stylesheet" href="css/videoPlayer.theme4.css" type="text/css">
  ...
  <style type="text/css" media="screen">
    body
    {
      background: #a5b6c7 url(images/1.jpg) repeat;
        /*margin: 0;*/
        /*width: 0px;*/
        /*height: 0px;*/
    }
    ...
    #video
    {
        -webkit-box-shadow: 0px 10px 30px rgb(15, 15, 15);
        -moz-box-shadow: 0px 10px 30px rgb(15, 15, 15);
        box-shadow: 0px 10px 30px rgb(15, 15, 15);
      margin: 5% auto;
      width: 746px;
      height: 420px;
    }
